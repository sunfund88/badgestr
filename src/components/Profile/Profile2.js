...
import { onlyUnique, getReadRelays, getWriteRelays, getAllRelays } from '../BadgeStrFunction';
import './Profile.css';
...
function Profile() {
    ...
    return (
        <div>
            ...
            <ProfileBadges pubkey={pubKeyRef.current} badges={badges} badgesObj={badgesObj} diffObj={diffObj} />
        </div>
